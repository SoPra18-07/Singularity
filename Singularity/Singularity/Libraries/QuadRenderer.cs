...
namespace Singularity.Libraries
{
    ...
    public class QuadRenderer
    {
        ...
        private readonly VertexPositionTexture[] _mVertexBuffer;
        private readonly short[] _mIndexBuffer;
        ...
        {
            _mVertexBuffer = new VertexPositionTexture[4];
            _mVertexBuffer[0] = new VertexPositionTexture(new Vector3(-1, 1, 1), new Vector2(0, 0));
            _mVertexBuffer[1] = new VertexPositionTexture(new Vector3(1, 1, 1), new Vector2(1, 0));
            _mVertexBuffer[2] = new VertexPositionTexture(new Vector3(-1, -1, 1), new Vector2(0, 1));
            _mVertexBuffer[3] = new VertexPositionTexture(new Vector3(1, -1, 1), new Vector2(1, 1));

            _mIndexBuffer = new short[] { 0, 3, 2, 0, 1, 3 };
        ...
        {
            _mVertexBuffer[0].Position.X = v1.X;
            _mVertexBuffer[0].Position.Y = v2.Y;

            _mVertexBuffer[1].Position.X = v2.X;
            _mVertexBuffer[1].Position.Y = v2.Y;

            _mVertexBuffer[2].Position.X = v1.X;
            _mVertexBuffer[2].Position.Y = v1.Y;

            _mVertexBuffer[3].Position.X = v2.X;
            _mVertexBuffer[3].Position.Y = v1.Y;

            graphicsDevice.DrawUserIndexedPrimitives
                (PrimitiveType.TriangleList, _mVertexBuffer, 0, 4, _mIndexBuffer, 0, 2);
