...
namespace Singularity.Screen.ScreenClasses
{
    ...
    internal sealed class GamePauseManagerScreen : IScreen
    {
        ...
        public void Update(GameTime gametime)
        {
            ...
            {
                Initialize(sViewportResolution, sResolutionChanged, mGame, mDirector);
        ...
        /// <summary>
        /// Receives Quit Game button released event and exits game.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="eventArgs"></param>
        public static void OnQuitGameButtonReleased(Object sender, EventArgs eventArgs)
        {
            sPressed = "Quit Game";
        }
