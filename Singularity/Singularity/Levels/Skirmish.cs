...
namespace Singularity.Levels
{
    ...
    internal sealed class Skirmish : BasicLevel
    {
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            // Enemy Unit
            var milUnit = new MilitaryUnit(new Vector2(2950, 2950), Camera, ref mDirector, ref map);
            ...
            //TESTMETHODS HERE ====================================
            mDirector.DistributionDirector.GetManager(0).RequestResource(platform2, EResourceType.Oil, null);
        }
